...
// const Hero = () => {
//   return (
//     <motion.section className="relative h-screen w-full bg-[#1A002D] text-white overflow-hidden px-6 font-sans">
//       {/* Stars */}
...
//       {/* Content */}
//       <div className="relative z-20 h-full flex flex-col justify-center items-center text-center font-sans">
//         {/* Image */}
//         <motion.img
//           src="/assets/cityscape.png"
//           alt="Cityscape"
//           className="w-[900px] md:w-[1100px] relative -mb-6"
//           initial={{ opacity: 0, y: 50 }}
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ duration: 1, delay: 0.6 }}
//         />

//         {/* Text closer to image base */}
//         <div className="-mt-20 relative z-30">
//           <motion.h1
//             className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-purple-400 to-white bg-clip-text text-transparent p-4 relative z-30"
//             initial={{ opacity: 0, y: -50 }}
//             animate={{ opacity: 1, y: 0 }}
...
//           <motion.p
//             className="mt-2 text-lg relative z-30"
...
//       >
//         <button className="px-10 py-4 rounded-md bg-gradient-to-r from-[#7B2FF7] to-[#3A0CA3] text-white font-semibold shadow-lg hover:scale-105 hover:shadow-purple-500/50 transition-transform">
//           Get Started Today
//         </button>
//       </motion.div>
//     </motion.section>
...
//           src="/assets/cityscape.png"
//           alt="Cityscape"
//           className="w-[80%] max-w-[320px] sm:max-w-[500px] md:max-w-[800px] lg:max-w-[1000px] mb-4 sm:mb-6"
//           initial={{ opacity: 0, y: 40 }}
//           animate={{ opacity: 1, y: 0 }}
...
//         {/* Heading + paragraph */}
//         <motion.h1
//           className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-purple-400 to-white bg-clip-text text-transparent leading-snug sm:leading-tight"
//           initial={{ opacity: 0, y: -30 }}
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ duration: 1 }}
//         >
...
//         <motion.p
//           className="mt-2 sm:mt-3 text-sm sm:text-base md:text-lg text-gray-300 max-w-[90%] sm:max-w-[600px]"
