        ...
        <div className="relative max-w-[1060px] mx-auto w-full">
          ...
          <div className="relative flex flex-col md:flex-row gap-2 h-auto md:h-[726px]">
            ...
            <div className="flex flex-col gap-2 w-full md:w-[632px]">
              <div className="h-[250px] md:h-[287px] p-6 relative rounded-sm overflow-hidden bg-[url('/website.png'),_linear-gradient(to_top_right,_#1A002D,_#481F66)] bg-cover bg-no-repeat">
                <h3 className="text-white text-xl font-semibold mb-2">
                  Website design <br /> & Development
                </h3>
                <p className="text-sm text-[#b3a6ff]">
              ...
              <div className="flex-1 min-h-[200px] p-6 relative rounded-sm overflow-hidden bg-[url('/setUp.png'),_linear-gradient(to_top_right,_#1A002D,_#481F66)] bg-cover bg-no-repeat">
                <h3 className="text-white text-xl font-semibold mb-2">
                  Network Setup <br /> & Management
                </h3>
                <p className="text-sm text-[#b3a6ff]">
            ...
            <div className="flex flex-col gap-2 flex-1 w-full">
              <div className="h-[250px] md:h-[439px] p-6 relative rounded-sm overflow-hidden bg-[url('/ictSupport.png'),_linear-gradient(to_top_right,_#1A002D,_#481F66)] bg-cover bg-center bg-no-repeat">
                <h3 className="text-white text-xl font-semibold mb-2">
                  ICT Support
                </h3>
                <p className="text-sm text-[#b3a6ff]">
              ...
              <div className="flex-1 min-h-[200px] p-6 relative rounded-sm overflow-hidden bg-[url('/consult.png')] bg-cover bg-no-repeat">
                <div className="absolute inset-0 bg-gradient-to-tr from-[#1A002D]/80 to-[#481F66]/80 mix-blend-multiply"></div>
                <div className="relative z-10">
                  <h3 className="text-white text-xl font-semibold mb-2">
                    IT Consulting
